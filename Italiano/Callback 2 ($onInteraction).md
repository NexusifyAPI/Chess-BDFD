...
$if[$var[state]==]
$ephemeral
$addTextDisplay[❌ Non hai una partita attiva. Esegui \`$var[trigger]\` per crearne una.]
$stop
$endif
...
$ephemeral
$addTextDisplay[❌ Questa partita non è più attiva. Esegui \`$var[trigger]\` per crearne una nuova.]
$stop
$endif
...
$addTextDisplay[# ♟️ **Scacchi — Muovere pezzo**

**Pezzo selezionato:** $var[pieceName] in \`$var[fromSquare]\`
...
$addSeparator[true;small;main]
$addTextDisplay[🎯 **Dove muovere?** Seleziona una casa di destinazione:;main]
$addActionRow[r1;main]
$addStringSelect[chdest~$var[wID]~$var[gID]~$var[fromSquare];Seleziona destinazione...;1;1;;r1]
...
$addButtonCV2[chbp~$var[wID]~$var[gID];⬅️ Indietro;secondary;false;;ctrl]
...
$if[$var[legal]!=true]
$ephemeral
$addTextDisplay[❌ Mossa illegale: $httpResult[error]]
$stop
$endif
...
$addTextDisplay[# ♟️ **Scacchi — Promozione**

Il tuo pedone in \`$var[fromSquare]\` ha raggiunto l'ultima riga. Scegli il pezzo per la promozione:;main]
$addSeparator[true;small;main]
$addMediaGallery[board;main]
$addMediaGalleryItem[$var[boardUrl];Scacchiera;false;board]
$addSeparator[true;small;main]
$addActionRow[r1;main]
$addStringSelect[chpr~$var[wID]~$var[gID]~$var[fromSquare]~$var[toSquare];Scegli il pezzo di promozione...;1;1;;r1]
$addStringSelectOption[♕ Donna;q;Promuovi a donna (★ consigliato);♕;;chpr~$var[wID]~$var[gID]~$var[fromSquare]~$var[toSquare]]
$addStringSelectOption[♖ Torre;r;Promuovi a torre;;;chpr~$var[wID]~$var[gID]~$var[fromSquare]~$var[toSquare]]
$addStringSelectOption[♗ Alfiere;b;Promuovi a alfiere;;;chpr~$var[wID]~$var[gID]~$var[fromSquare]~$var[toSquare]]
$addStringSelectOption[♘ Cavallo;n;Promuovi a cavallo;;;chpr~$var[wID]~$var[gID]~$var[fromSquare]~$var[toSquare]]
$addSeparator[true;small;main]
$addActionRow[ctrl;main]
$addButtonCV2[chbpr~$var[wID]~$var[gID]~$var[fromSquare];⬅️ Indietro;secondary;false;;ctrl]
$stop
$endif
