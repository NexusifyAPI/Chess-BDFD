...
$addTextDisplay[❌ Hai già una partita in corso. Annulla la partita precedente per crearne una nuova.;errbox]
...
$ephemeral
$addContainer[errbox;#ED4245;false]
$addTextDisplay[❌ Hai già una sfida in attesa. Annulla la sfida precedente per crearne una nuova.;errbox]
$addSeparator[true;small;errbox]
$addActionRow[forcebtn;errbox]
