...
$addTextDisplay[❌ Você já tem uma partida em andamento. Cancele a partida anterior para criar uma nova.;errbox]
...
$ephemeral
$addContainer[errbox;#ED4245;false]
$addTextDisplay[❌ Você já tem um desafio pendente. Cancele o desafio anterior para criar um novo.;errbox]
$addSeparator[true;small;errbox]
$addActionRow[forcebtn;errbox]
