...
$addSeparator[true;small;main]
$addMediaGallery[board;main]
$addMediaGalleryItem[http://chess.nexusify.co:26102/board.png?fen=$url[encode;$var[fen]]&perspective=$var[perspective]&size=600&theme=$var[theme];Tabuleiro atual;false;board]
$addSeparator[true;small;main]
$addActionRow[r1;main]
