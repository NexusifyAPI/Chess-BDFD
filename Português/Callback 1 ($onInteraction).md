...
$if[$var[state]==]
$ephemeral
$addTextDisplay[❌ Este desafio não está mais ativo. Ejecuta \`$var[trigger]\` de nuevo.]
$stop
$endif
...
$if[$authorID!=$var[bID]]
$ephemeral
$addTextDisplay[❌ Você não é jogador desta partida. Ejecuta \`$var[trigger]\` para crear la tuya.]
$stop
$endif
$endif
