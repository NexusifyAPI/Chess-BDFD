...
$if[$var[state]==]
$ephemeral
$addTextDisplay[❌ Este desafio não está mais ativo. Execute \`$commandTrigger\` novamente.]
$stop
$endif
...
$ephemeral
$addTextDisplay[❌ Você já tem um desafio pendente.]
$stop
$endif
$endif
...
$if[$var[state]==]
$ephemeral
$addTextDisplay[❌ Você não tem partida ativa. Execute \`$commandTrigger\` para criar uma.]
$stop
$endif
...
$if[$var[gID]!=$var[curGID]]
$ephemeral
$addTextDisplay[❌ Esta partida não está mais ativa. Execute \`$commandTrigger\` para criar uma nova.]
$stop
$endif
...
$if[$authorID!=$var[bID]]
$ephemeral
$addTextDisplay[❌ Você não é jogador desta partida. Execute \`$commandTrigger\` para criar a sua.]
$stop
$endif
$endif
...
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|$var[finalStatus]|-|Rendição|$var[theme]]
$setVar[chess_state;$var[newState];$var[wID]]
...
$defer
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|d|-|Empate aceito|$var[theme]]
$setVar[chess_state;$var[newState];$var[wID]]
