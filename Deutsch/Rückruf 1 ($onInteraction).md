...
$if[$var[state]==]
$ephemeral
$addTextDisplay[❌ Diese Herausforderung ist nicht mehr aktiv. Führe \`$commandTrigger\` erneut aus.]
$stop
$endif
...
$ephemeral
$addTextDisplay[❌ Du hast bereits eine laufende Partie. Beende sie oder gib auf, bevor du eine neue erstellst.]
$stop
$endif
...
$if[$authorID!=$var[bID]]
$ephemeral
$addTextDisplay[❌ Du bist kein Spieler dieser Partie. Führe \`$commandTrigger\` aus, um deine eigene zu erstellen.]
$stop
$endif
$endif
...
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|$var[finalStatus]|-|Aufgabe|$var[theme]]
$setVar[chess_state;$var[newState];$var[wID]]
...
$defer
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|d|-|Remis vereinbart|$var[theme]]
$setVar[chess_state;$var[newState];$var[wID]]
