...
$if[$var[opponentID]==]
$addTextDisplay[❌ Du musst einen Gegner erwähnen. Verwendung: \`!chess @nutzer\`]
$stop
$endif
$endif
...
$ephemeral
$addTextDisplay[❌ Du hast bereits eine ausstehende Herausforderung. Brich sie ab, bevor du eine neue erstellst.]
$stop
$endif
$endif
