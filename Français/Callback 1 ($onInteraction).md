...
$if[$var[state]==]
$ephemeral
$addTextDisplay[❌ Ce défi n'est plus actif. Exécutez \`$var[trigger]\` à nouveau.]
$stop
$endif
...
$ephemeral
$addTextDisplay[❌ Vous avez déjà un défi en attente. Annulez le défi précédent pour en créer un nouveau.]
$stop
$endif
$endif
...
$if[$authorID!=$var[bID]]
$ephemeral
$addTextDisplay[❌ Vous n'êtes pas un joueur de cette partie. Exécutez \`$var[trigger]\` pour créer la vôtre.]
$stop
$endif
$endif
...
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|$var[finalStatus]|-|Abandon|$var[theme]|$var[trigger]]
$setVar[chess_state;$var[newState];$var[wID]]
...
$defer
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|d|-|Nulle acceptée|$var[theme]|$var[trigger]]
$setVar[chess_state;$var[newState];$var[wID]]
...
$addSeparator[true;small;main]
$addMediaGallery[board;main]
$addMediaGalleryItem[http://chess.nexusify.co:26102/board.png?fen=$url[encode;$var[fen]]&perspective=$var[perspective]&size=600&theme=$var[theme];Échiquier actuel;false;board]
$addSeparator[true;small;main]
$addActionRow[r1;main]
