...
$if[$var[state]==]
$ephemeral
$addTextDisplay[❌ This challenge is no longer active. Run \`$commandTrigger\` again.]
$stop
$endif
...
$if[$authorID!=$var[bID]]
$ephemeral
$addTextDisplay[❌ You are not a player in this game. Run \`$commandTrigger\` to create your own.]
$stop
$endif
$endif
...
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|$var[finalStatus]|-|Resignation|$var[theme]]
$setVar[chess_state;$var[newState];$var[wID]]
...
$defer
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|d|-|Draw agreed|$var[theme]]
$setVar[chess_state;$var[newState];$var[wID]]
