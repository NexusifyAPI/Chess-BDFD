...
$addTextDisplay[❌ You already have an ongoing game. Cancel the previous game to create a new one.;errbox]
...
$ephemeral
$addContainer[errbox;#ED4245;false]
$addTextDisplay[❌ You already have a pending challenge. Cancel the previous challenge to create a new one.;errbox]
$addSeparator[true;small;errbox]
$addActionRow[forcebtn;errbox]
