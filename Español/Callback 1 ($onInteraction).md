...
$if[$var[state]==]
$ephemeral
$addTextDisplay[❌ Este reto ya no está activo. Ejecuta \`$var[trigger]\` de nuevo.]
$stop
$endif
...
$if[$authorID!=$var[bID]]
$ephemeral
$addTextDisplay[❌ No eres jugador de esta partida. Ejecuta \`$var[trigger]\` para crear la tuya.]
$stop
$endif
$endif
...
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|$var[finalStatus]|-|Rendición|$var[theme]|$var[trigger]]
$setVar[chess_state;$var[newState];$var[wID]]
...
$defer
$var[newState;$var[fen]|$var[wID]|$var[bID]|$var[gID]|d|-|Tablas acordadas|$var[theme]|$var[trigger]]
$setVar[chess_state;$var[newState];$var[wID]]
...
$addSeparator[true;small;main]
$addMediaGallery[board;main]
$addMediaGalleryItem[http://chess.nexusify.co:26102/board.png?fen=$url[encode;$var[fen]]&perspective=$var[perspective]&size=600&theme=$var[theme];Tablero actual;false;board]
$addSeparator[true;small;main]
$addActionRow[r1;main]
...
$if[$authorID!=$var[wID]]
$ephemeral
$addTextDisplay[❌ Solo el retador puede cancelar su partida anterior.]
$stop
$endif
